...
nuc demulti -m tests/sampleInfo.tsv \
...
nuc trim tests/test_output/testSeq-1.R2.fastq.gz \
...
nuc trim tests/test_output/testSeq-1.R1.fastq.gz \
...
nuc filt tests/Data/Undetermined_S0_L001_I1_001.fastq.gz \
...
nuc filt tests/test_output/testSeq-1.R2.trim.fastq.gz tests/test_output/testSeq-1.R1.trim.fastq.gz \
...
nuc filt tests/Data/Undetermined_S0_L001_R1_001.fastq.gz -o tests/test_output/seq_filt_R1.fastq \
...
nuc consol tests/test_output/testSeq-1.R2.filt.fastq.gz \
...
nuc consol tests/test_output/testSeq-1.R1.filt.fastq.gz \
...
nuc couple tests/Data/testSeq-1.R2.psl.gz tests/Data/testSeq-1.R1.psl.gz \
