...
Rscript scripts/demulti.R -m etc/test.sampleinfo.csv \
...
Rscript scripts/trim.R etc/test_output/testSeq-1.R2.fastq.gz \
...
Rscript scripts/trim.R etc/test_output/testSeq-1.R1.fastq.gz \
...
Rscript scripts/filt.R etc/test_data/Undetermined_S0_L001_I1_001.fastq.gz \
...
Rscript scripts/filt.R etc/test_output/testSeq-1.R2.trim.fastq.gz etc/test_output/testSeq-1.R1.trim.fastq.gz \
...
Rscript scripts/filt.R etc/test_data/Undetermined_S0_L001_R1_001.fastq.gz -o etc/test_output/seq_filt_R1.fastq \
...
Rscript scripts/consol.R etc/test_output/testSeq-1.R2.filt.fastq.gz \
...
Rscript scripts/consol.R etc/test_output/testSeq-1.R1.filt.fastq.gz \
...
Rscript scripts/couple.R etc/test_data/testSeq-1.R2.psl.gz etc/test_data/testSeq-1.R1.psl.gz \
